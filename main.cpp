...
void findKeypoints(const char*, int min_hessian=400);
void testHomography(int min_hessian=400); //this code is not working yet
bool debug = false;
...
void testHomography(int min_hessian){
    Mat img_object = imread( "../images/test.jpg", CV_LOAD_IMAGE_COLOR );
    Mat img_scene = imread( "../images/11.jpg", CV_LOAD_IMAGE_COLOR );

    img_object.convertTo(img_object,CV_LOAD_IMAGE_GRAYSCALE);
    img_scene.convertTo(img_scene,CV_LOAD_IMAGE_GRAYSCALE);
  ...
  //  imshow( "Good Matches & Object detection", img_matches );
    imwrite("../images/output.jpg",img_matches);
